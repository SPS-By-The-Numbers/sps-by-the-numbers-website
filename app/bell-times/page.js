...
function makeData() {
  ...
  return {
    ...
    initialFilters: [
      ...
      makeItem(
        "no-plans-on-bus",
        "Not Planning to Bus in 2022-2023",
        true,
        "grey",
      ),
      makeItem(
        "need-transit-help",
        "W/o bus would need transit help",
        true,
        "grey",
      ),
      makeItem(
        "no-need-transit-help",
        "W/o bus would NOT need transit help",
        true,
        "grey",
      ),
      ...
      makeItem(
        "no-split-bell-time",
        "Not split between tier 1 and 3",
        true,
        "grey",
      ),
      makeItem(
        "childcare-challenges",
        "3-bells = childcare challenges",
        true,
        "grey",
      ),
      makeItem(
        "no-childcare-childcare",
        "3-bells will not create childcare challenges",
        true,
        "grey",
      ),
      makeOption(
