    ...
    <main className={styles.main}>
      <div className="p-4">
        <div className={styles.title}>
          <h1>Notes from Conv w/ Director Hampson on 2022 Strike</h1>
        </div>

        <div className={styles.card}>
          Somewhere late on Sept 8, 2022, 2 days into the 2022 Teacher Strike, a user made a post on `/r/Seattle` politics claiming to have detatils notes from an hour long phone conversation Director Hampson allegedly made in
