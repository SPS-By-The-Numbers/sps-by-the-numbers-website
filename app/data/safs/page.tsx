...
export default function Page() {
  return (
    <SectionPage
      ...
      intro={
        <>
          OSPI&apos;s School Apportionment and Financial Services (SAFS)
          machine-readable financial data for every district in the state: the
          F-195 budget and F-196 actuals databases, per-section AVRO splits,
          joined cross-year files, and the lookup tables for the accounting
          codes. This is what the{" "}
          <Link href="/finance/vitals">Finance Dashboard</Link> is built on. The
          scanned PDF originals (which capture dimensions missing here, like
